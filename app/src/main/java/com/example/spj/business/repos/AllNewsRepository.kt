...
class AllNewsRepository {
    ...
    fun getFootballListReading() : LiveData<MutableList<NewsModel>>{
        val footballList = Constants.getFootball()
        val mutableData = MutableLiveData<MutableList<NewsModel>>()
        val list = mutableListOf<NewsModel>()

        for (i in footballList){
            val id = i.id
            val iconTop = i.iconTop
            val title = i.title
            val descTop = i.descTop
    ...
    fun getTennisListReading() : LiveData<MutableList<NewsModel>>{
        val tennisList = Constants.getTennis()
        val mutableData = MutableLiveData<MutableList<NewsModel>>()
        val list = mutableListOf<NewsModel>()
    ...
    fun getBaseballListReading() : LiveData<MutableList<NewsModel>>{
        val baseballList = Constants.getBaseball()
        val mutableData = MutableLiveData<MutableList<NewsModel>>()
        val list = mutableListOf<NewsModel>()
